...
$PHPMAILER_LANG['authenticate']         = 'خطای sendsmtp: احراز هویت با شکست مواجه شد.';
$PHPMAILER_LANG['connect_host']         = 'خطای sendsmtp: اتصال به سرور sendsmtp برقرار نشد.';
$PHPMAILER_LANG['data_not_accepted']    = 'خطای sendsmtp: داده‌ها نا‌درست هستند.';
...
$PHPMAILER_LANG['recipients_failed']    = 'خطای sendsmtp: ارسال به آدرس گیرنده با خطا مواجه شد: ';
$PHPMAILER_LANG['signing']              = 'خطا در امضا: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'خطا در اتصال به sendsmtp.';
$PHPMAILER_LANG['smtp_error']           = 'خطا در sendsmtp Server: ';
