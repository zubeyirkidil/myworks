...
$PHPMAILER_LANG['authenticate']         = 'sendsmtp Σφάλμα: Αδυναμία πιστοποίησης (authentication).';
$PHPMAILER_LANG['connect_host']         = 'sendsmtp Σφάλμα: Αδυναμία σύνδεσης στον sendsmtp-Host.';
$PHPMAILER_LANG['data_not_accepted']    = 'sendsmtp Σφάλμα: Τα δεδομένα δεν έγιναν αποδεκτά.';
...
$PHPMAILER_LANG['recipients_failed']    = 'sendsmtp Σφάλμα: Οι παρακάτω διευθύνσεις παραλήπτη δεν είναι έγκυρες: ';
$PHPMAILER_LANG['signing']              = 'Σφάλμα υπογραφής: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'Αποτυχία σύνδεσης στον sendsmtp Server.';
$PHPMAILER_LANG['smtp_error']           = 'Σφάλμα από τον sendsmtp Server: ';
